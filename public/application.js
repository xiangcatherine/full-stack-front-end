...
/***/ (function(module, exports, __webpack_require__) {
	...
	var babyEvents = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://expecting.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uxEvents = __webpack_require__(9);
	...
	var onSignOut = function onSignOut(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signOut(data).then(ui.signOutSuccess).catch();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpAppear = function signUpAppear() {
	  $('#sign-up').removeClass('hidden');
	};

	var signInAppear = function signInAppear() {
	  $('#sign-in').removeClass('hidden');
	};

	var changePasswordAppear = function changePasswordAppear() {
	  $('#change-password').removeClass('hidden');
	};

	module.exports = {
	  signUpAppear: signUpAppear,
	  signInAppear: signInAppear,
	  changePasswordAppear: changePasswordAppear
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(8);
	var babyApi = __webpack_require__(14);
	var babyUi = __webpack_require__(15);

	var onGetBaby = function onGetBaby(event) {
	  // event.preventDefault()
	  babyApi.getBaby().then(babyUi.getBabySuccess).catch();
	};

	var onCreateBaby = function onCreateBaby(event) {
	  event.preventDefault();
	  var data = getFormFields(event.currentTarget);
	  babyApi.createBaby(data).then(babyUi.createBabySuccess).catch();
	};

	var onUpdateBaby = function onUpdateBaby(event) {
	  event.preventDefault();
	  babyApi.updateBaby().then(babyUi.updateBabySuccess).catch(babyUi.updateBabyFailure);
	};

	var onDeleteBaby = function onDeleteBaby(event) {
	  event.preventDefault();
	  babyApi.deleteBaby().then(babyUi.deleteBabySuccess).catch(babyUi.deleteBabyFailure);
	};

	var addBabyHandlers = function addBabyHandlers() {
	...
	module.exports = {
	  ...
	  addBabyHandlers: addBabyHandlers,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createBaby = function createBaby(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/babies',
	    method: 'POST',
	    headers: {
	...
	var updateBaby = function updateBaby() {
	  return $.ajax({
	...
	var deleteBaby = function deleteBaby(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/babies/' + store.babyId,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var babyDisplay = __webpack_require__(16);

	var createBabySuccess = function createBabySuccess(response) {
	...
	var getBabySuccess = function getBabySuccess(response) {
	  if (response === null) {
	...
	var updateBabySuccess = function updateBabySuccess(response) {
	  $('.view-baby-stat').addClass('hidden');
	  if ($('.baby-size-display').hasClass('hidden')) {
	    $('.baby-size-display').removeClass('hidden');
	  }
	...
	var updateBabyFailure = function updateBabyFailure() {
	  $('.update-baby-error').text("Sorry, we were unable to get you're baby's status. Please try again!");
	};

	var deleteBabySuccess = function deleteBabySuccess() {
	...
	var deleteBabyFailure = function deleteBabyFailure() {
	  $('.remove-baby-message').text('Sorry, we were unable to reset.');
	};

	module.exports = {
	  getBabySuccess: getBabySuccess,
	  createBabySuccess: createBabySuccess,
	  updateBabySuccess: updateBabySuccess,
	  updateBabyFailure: updateBabyFailure,
	  deleteBabySuccess: deleteBabySuccess,
	  deleteBabyFailure: deleteBabyFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getImgBasedOnAge = function getImgBasedOnAge(response) {
	  var week = response['baby']['age'];
	  ...
	  var imgSource = "https://raw.githubusercontent.com/xiangcatherine/full-stack-front-end/master/assets/images/week" + week + ".png";
	  $('.baby-size-img').attr('src', imgSource);
	};

	// Gets the corresponding text message
	var getBabySizeText = function getBabySizeText(response) {
	  var age = response['baby']['age'];
	  var updateText = '';
	...
	var updateBabySizeText = function updateBabySizeText(message) {
	  $('.baby-size-text').text(message);
	};

	module.exports = {
	  getImgBasedOnAge: getImgBasedOnAge,
	  getBabySizeText: getBabySizeText,
	  updateBabySizeText: updateBabySizeText
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
